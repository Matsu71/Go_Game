...
3. Main agent checks for an exact duplicate or near-duplicate in canonical by comparing starting board, goal, target white group, local shape, vital point, killing idea, and intended solution.
