...
- `第8問` は黒先白死の3手詰めで、正しい初手のあと白の最強応手が0.5秒後に自動で入り、最後の黒で仕留めます。
...
- `solutions`: `winningFirstMoves`、`principalVariation`、`alternativeLines`、`isUniqueFirstMove`、必要なら `wrongFirstMoveDefense`
